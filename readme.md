...
This will create: `target/SHAFT_MCP-10.2.20260422.jar`
...
```json
{
  "mcpServers": {
    "shaft-mcp": {
      ...
      "args": [
        "-jar",
        "/FULL/PATH/TO/SHAFT_MCP/target/SHAFT_MCP-10.2.20260422.jar"
      ]
    }
  }
}
...
```json
{
  "mcpServers": {
    "shaft-mcp": {
      "command": "java",
      "args": ["-jar", "/path/to/SHAFT_MCP-10.2.20260422.jar"]
    },
    "github": {
      "command": "npx",
